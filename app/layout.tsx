...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://hijabbugil.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Korea Tante China Live Paksa Bokep Abg Terbaru`,
        "logo": "https://hijabbugil.pages.dev/favicon.ico",
        "url": "https://hijabbugil.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://hijabbugil.pages.dev"
        ...
        "url": "https://hijabbugil.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Bocil Jepang Ngentot Jav Jilbab Smp Barat Mama Viral Sma Korea Tante China Live Paksa Bokep Abg Terbaru`,
        "image": "https://hijabbugil.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://hijabbugil.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://hijabbugil.pages.dev/?q={search_term}", 
